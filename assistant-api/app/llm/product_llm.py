        ...
        return ChatPromptTemplate.from_messages(
            [
                HumanMessagePromptTemplate.from_template(
                    ...
                    "Ou quando houver promoção, ele ficará no formata: id,name,brand,category_name,unit_weight unit_type,unit_price,stock_quantity,priority,PROMO:description,promotional_price,initial_date,final_date;:\n"
                    "{products}\n\n"
